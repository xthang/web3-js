...
describe('Test Interface', function () {
  const iface = new Interface(ChainNamespace.eip155, ['function balanceOf(address owner) returns (uint)', 'event Transfer(address indexed from, address indexed to, uint amount)'])
