...
async function getSubscription(_event: ProviderEvent, provider: AbstractProvider): Promise<Subscription> {
    ...
    if (provider.chainNamespace === ChainNamespace.solana || provider.chainNamespace === ChainNamespace.tron) {
...
export class AbstractProvider implements Provider {
    ...
    async lookupAddress(address: string): Promise<null | string> {
        ...
        try {
            ...
            const ensContract = new Contract(this.chainNamespace, ensAddr, [
            ...
            const resolverContract = new Contract(this.chainNamespace, resolver, [
