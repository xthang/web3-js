...
import { keccak256_hex, pbkdf2, randomBytes, scrypt, scryptSync } from '../crypto/index.js'
...
function getAccount(data: any, _key: string, chainNamespace: ChainNamespace): KeystoreAccount {
  ...
  assertArgument(computedMAC === spelunk<string>(data, 'crypto.mac:string!').toLowerCase(), 'incorrect password', 'password', '[ REDACTED ]')
